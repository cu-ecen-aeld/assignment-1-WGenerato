...
//#include "/home/tt20/examples/autotest-validate/autotest-validate.c"
/**
...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(expected, actual, "The expected and actual usernames are not equal"); 
    free(actual);// free the dynamically allocated memory created using malloc
}
